...
/*_RB_ Hard coded to ipSIZE_OF_IP_HEADER_IPv4, could it be ipSIZE_OF_IP_HEADER_IPv6? */
/*_HT_ Correct because only IPv4 has an IP-header-checksum. It has just been confirmed that: usFrameType != ipIPv6_FRAME_TYPE. */
