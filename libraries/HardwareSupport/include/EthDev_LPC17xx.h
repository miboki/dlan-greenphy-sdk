...
#ifndef NUM_RX_FRAG
#define NUM_RX_FRAG         5           /* Num.of RX Fragments. */
#endif
#ifndef NUM_TX_FRAG
...
#ifndef LAN8720_ID
#define LAN8720_ID          0x00000007  /* PHY Identifier */
#endif
#define LAN_8710i_ID        0x0007c0f0  /* PHY Identifier */
...
#define PHY_INT_ENABLE       (1<<7)     /* Interrupt enable                  */
#define PHY_INT_AUTO_NEG_COMPLETE    (1<<6)     /* Interrupt on link down            */
#define PHY_INT_LINK_DOWN    (1<<4)     /* Interrupt on link down            */
#define PHY_AUTO_NEG_PAUSE_SYM   (1<<10)    /* Symmetric PAUSE     (half duplex)     */
#define PHY_AUTO_NEG_PAUSE_ASYM  (1<<11)    /* Asymmetric PAUSE    (full duplex)     */
#define PHY_AUTO_NEG_PAUSE_RES   (1<<10)    /* Symmetric PAUSE     */
